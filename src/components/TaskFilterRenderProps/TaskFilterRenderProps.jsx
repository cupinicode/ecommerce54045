...
const Filter = ({ children }) => {  // Recibe una función (NO un componente)
        ...
        <div>
            <Filter>
                {(filterState, handleFilterChange) => (
                    <div>
                        <label htmlFor="filter">Filtrar por estado:</label>  {/* Relaciona el LABEL con el SELECT, para que haciendo click en el LABEL, se haga foco en el SELECT */}
            ...
            {/* <TaskList tasks={tasks} /> */}  {/* Esto mostraría TODAS las tareas */}
        </div>
    )
}
